...
import irs.fdxtax641.jsonserializers.Tax1099SaSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Sa;
import org.taxdataexchange.core.pdfbuilders.Tax1099SaPdfBuilder;
...
public class Tax1099SaDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Sa obj = Map2Tax1099Sa.generate( row );
        {
            String asJson = Tax1099SaSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Sa.csv";
        ...
        String outputFileName = "Tax1099Sa.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099SaDocumentGenerator generator = new Tax1099SaDocumentGenerator( );
