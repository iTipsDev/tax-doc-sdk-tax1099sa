# tax-doc-sdk-tax1099sa

Software development kit to generate IRS Form 1099-SA as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Sa.sample.png" width="850"/>
